...
export class MySQLStorage implements IStorage {
    ...
    try {
      ...
      await connection.query(`
        CREATE TABLE IF NOT EXISTS settings (
          ...
          featuresSectionTitle VARCHAR(255) DEFAULT 'Why Choose PHEONIX Cloud?',
  ...
  async getSettings(): Promise<Settings> {
    ...
    return {
      ...
      heroDescription: row.heroDescription || "Experience blazing-fast performance with PHEONIX Cloud. 99.9% uptime guarantee, instant scaling, and 24/7 expert support.",
  ...
  async updateSettings(settings: Settings): Promise<Settings> {
    ...
    await this.query(
      ...
      [
        ...
        settings.featuresSectionTitle || "Why Choose PHEONIX Cloud?",
