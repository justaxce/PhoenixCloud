  ...
  app.get("/api/settings", async (req, res) => {
    try {
      ...
      res.status(503).json({ 
        ...
        heroDescription: "Experience blazing-fast performance with PHEONIX Cloud. 99.9% uptime guarantee, instant scaling, and 24/7 expert support.",
        stat1Value: "99.9%",
        ...
        featuresSectionTitle: "Why Choose PHEONIX Cloud?",
        ...
        ctaDescription: "Join thousands of satisfied customers who trust PHEONIX Cloud for their hosting needs. Get started in minutes.",
  ...
  app.get("/api/about", async (req, res) => {
    try {
      ...
      res.status(503).json({
        ...
        companyName: "PHEONIX Cloud",
        companyDescription: "Web & Game Hosting Business focused on high-performance hosting.",
        storyTitle: "The beginning",
        storyContent: "PHEONIX Cloud started with a simple goal: to provide reliable and high-performance server hosting.",
        yearsExperience: "1",
