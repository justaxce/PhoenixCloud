          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl space-y-2">
              ...
              <Card className="p-6 bg-card text-card-foreground shadow-lg">
                ...
                <p className="mb-4 leading-relaxed">We do not store bank details, card details, or passwords.</p>
                ...
                <p className="leading-relaxed">This is required for server stability and support.</p>
              </Card>
              ...
              <Card className="p-6 bg-card text-card-foreground shadow-lg">
                ...
                <p className="mb-4 leading-relaxed">Only the required technical information is shared — nothing more.</p>
              ...
              <Card className="p-6 bg-card text-card-foreground shadow-lg">
                ...
                <p className="leading-relaxed">However, no online service is 100% secure.</p>
              </Card>
              ...
              <Card className="p-6 bg-card text-card-foreground shadow-lg">
                ...
                <p className="leading-relaxed">Just open a ticket on our Discord server.</p>
              </Card>
